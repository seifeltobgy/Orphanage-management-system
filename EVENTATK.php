...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
	...
	<body >
		...
		<?php
                ...
                class EventView
                {
                     public function Show_AllEvents()
                    {
                         $Result= array();
						$Result=Events::SelectAllEvInDB();
						...
						{   
                             echo "<tr><td>".$Result[$i]->getEvent_id()."</td>";
                             echo"<td><a href=EventController.php?id=".$Result[$i]->getEvent_id().">".$Result[$i]->getTitle()."</a></td>";
                             echo"<td>".$Result[$i]->getDate()."</td>";
                             echo"<td>" .$Result[$i]->getContent()."</td>";
                             echo"<td>".$Result[$i]->getQueue()."</td>";
                             echo"<td>" .$Result[$i]->getFees();"</td></tr>";
							$i++;
						}
					}
