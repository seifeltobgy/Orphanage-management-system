...
<section class="signup">
    ...
    <div class="container" align=center>
        <div class="Add-content">
            <form action="AddDonTypeController.php" method="post">
            <div class="desc animate-box">
            <h2><strong>Add an Item here</strong></h2>
        
            <div class="form-group">
            <input type="string" class="form-input" name="ItemName" id="ItemName" placeholder="Enter Item name" required/>
            </div>
