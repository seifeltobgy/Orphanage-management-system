	...
	<body>
		...
		<?php 
            ...
            <tr>
                ...
                <td style="border-top: 1px solid #C0C0C0; border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: 1px solid #C0C0C0" align="center" valign=middle><font size=3><br></font><p> <b> <input type="text" name="FullName" value="<?php echo $Donation->Name($donation->getDonorID()) ?>" disabled> </b></p></td>
                <td style="border-right: 1px solid #C0C0C0" align="left" valign=bottom bgcolor="#ff5722"><br></td>
            </tr>
            ...
            <tr>
                <td style="border-left: 1px solid #C0C0C0" height="25" align="left" valign=bottom bgcolor="#ff5722"><br></td>
                <td style="border-top: 1px solid #C0C0C0; border-bottom: 1px solid #000000; border-left: 1px solid #C0C0C0; border-right: 1px solid #000000" align="center" valign=middle bgcolor="#000000"><b>Donation ID</b></td>
                <td style="border-top: 1px solid #C0C0C0; border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: 1px solid #C0C0C0" align="center" valign=middle><font size=3><br></font><p> <input type="text" name="Donation ID" value="<?php $DtyId ?>" disabled></p></td>
                <td style="border-right: 1px solid #C0C0C0" align="left" valign=bottom bgcolor="#ff5722"><br></td>
            <tr>
                <td style="border-left: 1px solid #C0C0C0" height="25" align="left" valign=bottom bgcolor="#ff5722"><br></td>
                ...
                <td style="border-top: 1px solid #C0C0C0; border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: 1px solid #C0C0C0" align="center" valign=middle><font size=3><br></font><p> <input type="text" name="Email" value="<?php echo $Donation->getEmail()?>" disabled></p></td>
                <td style="border-right: 1px solid #C0C0C0" align="left" valign=bottom bgcolor="#ff5722"><br></td>
            </tr>
            <tr>
                <td style="border-left: 1px solid #C0C0C0" height="25" align="left" valign=bottom bgcolor="#ff5722"><br></td>
                ...
                <td style="border-top: 1px solid #C0C0C0; border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: 1px solid #C0C0C0" align="center" valign=middle><font size=3><br></font><p> <input type="text" name="Address" value="<?php $Address ?>" disabled></p></td>
                <td style="border-right: 1px solid #C0C0C0" align="left" valign=bottom bgcolor="#ff5722"><br></td>
            </tr>
            <tr>
                <td style="border-left: 1px solid #C0C0C0" height="25" align="left" valign=bottom bgcolor="#ff5722"><br></td>
                ...
                <td style="border-top: 1px solid #C0C0C0; border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: 1px solid #C0C0C0" align="center" valign=middle><font size=3><br></font><p> <input type="text" name="Phone Number" value="<?php $phonenumber ?>" disabled></p></td>
                <td style="border-right: 1px solid #C0C0C0" align="left" valign=bottom bgcolor="#ff5722"><br></td>
            </tr>
            <tr>
                <td style="border-left: 1px solid #C0C0C0" height="25" align="left" valign=bottom bgcolor="#ff5722"><br></td>
				...
				<td style="border-top: 1px solid #C0C0C0; border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: 1px solid #C0C0C0" align="center" valign=middle><font size=3><br></font><p> <input type="text" name="Item" value="<?php $DonateType ?>" disabled></p></td>
                <td style="border-right: 1px solid #C0C0C0" align="left" valign=bottom bgcolor="#ff5722"><br></td>
            </tr>
            <tr>
                <td style="border-left: 1px solid #C0C0C0" height="25" align="left" valign=bottom bgcolor="#ff5722"><br></td>
                ...
                <td style="border-top: 1px solid #C0C0C0; border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: 1px solid #C0C0C0" align="center" valign=middle><font size=3 ><br></font><p> <input type="text" name="Amount" value="<?php $amount ?>" disabled></p></td>
                <td style="border-right: 1px solid #C0C0C0" align="left" valign=bottom bgcolor="#ff5722"><br></td>
            </tr>
			<tr>
                <td style="border-left: 1px solid #C0C0C0" height="25" align="left" valign=bottom bgcolor="#ff5722"><br></td>
                <td style="border-top: 1px solid #C0C0C0; border-bottom: 1px solid #000000; border-left: 1px solid #C0C0C0; border-right: 1px solid #000000" align="center" valign=middle bgcolor="#000000"><b>Tax</b></td>
                <td style="border-top: 1px solid #C0C0C0; border-bottom: 1px solid #000000; border-left: 1px solid #000000; border-right: 1px solid #C0C0C0" align="center" valign=middle><font size=3 ><br></font><p> <input type="text" name="Amount" value="<?php $tax ?>" disabled></p></td>
                <td style="border-right: 1px solid #C0C0C0" align="left" valign=bottom bgcolor="#ff5722"><br></td>
            </tr>
            <tr>
                <td style="border-left: 1px solid #C0C0C0" height="25" align="left" valign=bottom bgcolor="#ff5722"><br></td>
                ...
                <td style="border-top: 1px solid #C0C0C0; border-bottom: 1px solid #C0C0C0; border-left: 1px solid #000000; border-right: 1px solid #C0C0C0" align="center" valign=middle sdnum="1033;0;&quot;$&quot;#,##0.00_);\(&quot;$&quot;#,##0.00\)"><font size=3><br></font><p> <input type="text" name="Time" value="<?php $updated_at ?>" disabled ></p></td>
                <td style="border-right: 1px solid #C0C0C0" align="left" valign=bottom bgcolor="#ff5722"><br></td>
            </tr>
            <tr>
